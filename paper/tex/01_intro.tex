...
\item \textbf{Equilibrium characterisation.} We compute pure Nash equilibria
in both regimes and observe that, in the canonical symmetric $2$-player
setting, both regimes admit only \emph{asymmetric} pure NE. In the naive
regime the asymmetric equilibrium $(\eps_i, \eps_j) = (1, 8)$ leaves one
player exposed at $A = 0.275$ and the other at $A = 0$; the symmetric
equilibrium $(4, 4)$ yields $A_1 = A_2 = 0.123$. In the aware regime, both
players' equilibrium budgets drop and the asymmetric NE $(1, 2)$ has roughly
\emph{half} the total realised MIA advantage of the naive symmetric NE. The
aware regime mitigates but does not eliminate the externality.
